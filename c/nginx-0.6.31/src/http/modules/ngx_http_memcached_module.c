...
static ngx_int_t
ngx_http_memcached_pre_conf(ngx_conf_t *cf);
static ngx_int_t
ngx_http_memcached_post_conf(ngx_conf_t *cf);
...
static ngx_command_t ngx_http_memcached_commands[] =
  {
    ...
    { ngx_string("memcached_connect_timeout"), NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF
      | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1, ngx_conf_set_msec_slot,
        NGX_HTTP_LOC_CONF_OFFSET, offsetof(ngx_http_memcached_loc_conf_t, upstream.connect_timeout), NULL },

    { ngx_string("memcached_send_timeout"), NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF
      | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1, ngx_conf_set_msec_slot,
        NGX_HTTP_LOC_CONF_OFFSET, offsetof(ngx_http_memcached_loc_conf_t, upstream.send_timeout), NULL },
    ...
    { ngx_string("memcached_buffer_size"), NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF
      | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1, ngx_conf_set_size_slot,
        NGX_HTTP_LOC_CONF_OFFSET, offsetof(ngx_http_memcached_loc_conf_t, upstream.buffer_size), NULL },

    { ngx_string("memcached_read_timeout"), NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF
      | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1, ngx_conf_set_msec_slot,
        NGX_HTTP_LOC_CONF_OFFSET, offsetof(ngx_http_memcached_loc_conf_t, upstream.read_timeout), NULL },
    ...
    { ngx_string("memcached_next_upstream"), NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF
      | NGX_HTTP_LOC_CONF | NGX_CONF_1MORE, ngx_conf_set_bitmask_slot,
        NGX_HTTP_LOC_CONF_OFFSET, offsetof(ngx_http_memcached_loc_conf_t, upstream.next_upstream),
        &ngx_http_memcached_next_upstream_masks },

    { ngx_string("memcached_upstream_max_fails"), NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF
      | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
        ngx_http_memcached_upstream_max_fails_unsupported, 0, 0, NULL },

    { ngx_string("memcached_upstream_fail_timeout"), NGX_HTTP_MAIN_CONF
      | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
        ngx_http_memcached_upstream_fail_timeout_unsupported, 0, 0, NULL },
...
static ngx_http_module_t ngx_http_memcached_module_ctx =
  ...
  ngx_http_memcached_pre_conf, /* preconfiguration */
  ngx_http_memcached_post_conf, /* postconfiguration */
...
ngx_module_t ngx_http_memcached_module =
  { NGX_MODULE_V1, &ngx_http_memcached_module_ctx, /* module context */
...
static ngx_str_t ngx_http_memcached_prefix =
ngx_string("memcached_prefix");
static ngx_str_t ngx_http_memcached_suffix =
ngx_string("memcached_suffix");
static ngx_str_t ngx_http_memcached_key =
ngx_string("memcached_key");
/* static ngx_str_t ngx_http_memcached_value  = ngx_string("memcached_value"); */
...
static ngx_http_memcached_ctx_t *
ngx_http_memcached_get_ctx(ngx_http_request_t *r)
{
...
ngx_http_memcached_handler(ngx_http_request_t *r)
{
  ...
  /* return NGX_HTTP_INTERNAL_SERVER_ERROR; */
  /* } */
  ctx = ngx_http_memcached_get_ctx(r);
...
ngx_http_memcached_process_header(ngx_http_request_t *r)
{
  ...
  *p = '\0';
  ...
  if (ngx_strncmp(p, "VALUE ", sizeof("VALUE ") - 1) == 0) {
    ...
    ngx_http_memcached_loc_conf_t *lcf;
    ngx_http_variable_value_t *pv;
    ngx_http_variable_value_t *sv;

    lcf = ngx_http_get_module_loc_conf(r, ngx_http_memcached_module);
...
static ngx_int_t
ngx_http_memcached_add_suffix(ngx_http_memcached_ctx_t *ctx,
...
ngx_http_memcached_filter(void *data, ssize_t bytes)
{
  ...
  if (u->length == ctx->rest) {
    ...
    return ngx_http_memcached_add_suffix(ctx, u, r);
    /* return NGX_OK; */
  }
...
ngx_http_memcached_pass(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
  ...
  v = ngx_http_add_variable(cf, &ngx_http_memcached_prefix,
      NGX_HTTP_VAR_CHANGEABLE | NGX_HTTP_VAR_NOCACHEABLE);
  v->set_handler = value_set_handler;
  v->get_handler = value_get_handler;
  v->data = ngx_http_get_variable_index(cf, &ngx_http_memcached_prefix);
  ngx_http_add_variable(cf, &ngx_http_memcached_suffix, NGX_HTTP_VAR_CHANGEABLE
